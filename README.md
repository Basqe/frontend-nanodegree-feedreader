...
2. Suite that checks if the menu is hidden by default and ensures that visibility of the menu changes once the icon is clicked.
3. Suite that checks if there's at least a single entry element in feed.
